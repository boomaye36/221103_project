...
<div class="container">
		<div class="d-flex align-items-center mt-5">
			<label for="name" class="gymname"  ><b>트레이너 이름</b> </label>	
			<input type="text" id="name" name="name" class="form-control" placeholder="내용을 입력해주세요. ">
		</div>
		<div class="d-flex align-items-center mt-3">
			<label for="gymId" class="gymname"  ><b>트레이너 체육관 </b> </label>	
			<input type="number" id="gymId" name="gymId" class="form-control" placeholder="내용을 입력해주세요. ">
		</div>
		
		<div class="d-flex align-items-center mt-3">
			<label for="phoneNumber" class="gymname"  ><b>트레이너 전화번호 </b> </label>	
			<input type="text" id="phoneNumber" name="phoneNumber" class="form-control" placeholder="내용을 입력해주세요. ">
		</div>
		<div class="d-flex align-items-center mt-3">
			<label for="introduce" class="gymname"  ><b>트레이너 소개 </b> </label>	
			<input type="text" id="introduce" name="introduce" class="form-control" placeholder="내용을 입력해주세요. ">
		</div>
		<div class="d-flex align-items-center mt-3">
			<label for="rank" class="gymname"  ><b>트레이너 평점 </b> </label>	
